    ...
    <div className="min-h-screen relative bg-white dark:bg-gray-900">
      ...
      <div className="max-w-2xl pt-20 pb-32 px-6 text-center mx-auto">
        ...
        <p className="text-gray-600 mt-4 dark:text-indigo-200">
          I am a self taught developer currently pursuing Bachelors Degree in Computer Engg 
          in Dr D.Y. Patil Institue of Technology. My field of Interest's are building new Web
          Technologies and Products and also in areas related to Machine Learning
          and Cybersecurity.
        </p>
        <br></br>
        <p style={{ color: "rgb(155 126 172)" }}>
            "Passionate Coder who builds stuffs via programing!"{" "}
          </p>
          -Vishvachaitanya
